		...
		try {
			...
			$options = [
				'headers' => [
					...
					'User-Agent' => 'Nextcloud Visavid integration'
				],
			];
			...
			$this->logger->warning('Visavid API error : '.$e->getMessage(), array('app' => $this->appName));
